<div class="wrapper fadeInDown">
    <div id="formContent">
        ...
        <div class="fadeIn first">
            <img src="../../web/images/logo-flevosap.png" id="icon" alt="Flevosap Logo"/>
        </div>
        ...
        <!-- Remind Passowrd -->
        <div id="formFooter">
            <a class="underlineHover" href="#">Wachtwoord vergeten?</a><br>
            <a class="underlineHover" href="../register.php">Nog geen account?</a>
        </div>
